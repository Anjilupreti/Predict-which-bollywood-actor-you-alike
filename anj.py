...
dataset_path = 'Bollywood_celeb_face_localized'

filenames = [sub.replace('/content/Bollywood_celeb_face_localized', dataset_path) for sub in filenames]
...
if uploaded_image is not None:
    ...
    if save_uploaded_image(uploaded_image):
        ...
        with col2:
            actor_name = os.path.basename(os.path.dirname(predicted_actor))

# Display the extracted actor's name
            st.subheader("Look Like: " + actor_name)
